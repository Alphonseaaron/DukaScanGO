      ...
      listener: (context, state) async {
        if (state is LoadingAuthState) {
          Navigator.pushReplacement(
              context, routeDukascango(page: CheckingLoginScreen()));
        } else if (state is LogOutAuthState) {
          Navigator.pushAndRemoveUntil(
              context, routeDukascango(page: LoginScreen()), (route) => false);
          ...
          if (!walkthroughCompleted) {
            if (state.rolId == '1') {
              ...
              Navigator.pushAndRemoveUntil(
                  context,
                  routeDukascango(page: ClientWalkthroughScreen()),
                  (route) => false);
              ...
              Navigator.pushAndRemoveUntil(
                  context,
                  routeDukascango(page: WholesalerWalkthroughScreen()),
                  (route) => false);
            }
          } else {
